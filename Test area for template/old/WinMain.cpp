...
//CBITMAP bitmap1; //temp
CBITMAP bitmap1("./bitmaps\\myface1.bmp");
CBITMAP bitmap2("./bitmaps\\Expl16.bmp");
//CBITMAP bitmap1("C:\\Documents and Settings\\Stephen Cirelli\\My Documents\\Visual Studio Projects\\DirectX programs\\Dummies test zone\\Test for DX7\\Test area for template\\bitmaps\\myface2.bmp");
CSPRITE sprite(42,36,14,6,3);
CSPRITE myface(63,63,1,1,1);
CSPRITE ship(56,38,3,3,1);
CSPRITE recttest(63,63,1,1,1);
CSPRITE ship2(57,55,12,12,1);

LPDIRECTDRAWSURFACE7 Temp;
//----------------------End Globals used for testing--------------------------------
...
{// this function is where i do all the initialization 
 // for the game
	...
	*/
	...
	//-----------------------------------------TEST OBJESTS AND FUNCTIONS--------------------------------------------------------------
	//load a bitmap
	bitmap1.LoadBitmapFile();
	bitmap2.LoadBitmapFile();
	//DisplayBitmapInfo(trying);
	//load sprite
	if(!sprite.LoadSpriteImage("./bitmaps\\Expl16.bmp"))
		return(0);
	myface.LoadSpriteImage("./bitmaps\\myface1.bmp");
	ship.LoadSpriteImage("./bitmaps\\star16.bmp");
	recttest.LoadSpriteImage("./bitmaps\\testRect.bmp");
	ship2.LoadSpriteImage("./bitmaps\\Shipsincells2.bmp");
	Temp = CreateSurface(320,200,TransColor);
	//-----------------------------------------END TEST OBJESTS AND FUNCTIONS----------------------------------------------------------
	return(1);
}

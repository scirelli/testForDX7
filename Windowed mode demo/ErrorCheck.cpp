...
char *DDErrorString(HRESULT hr, bool &bFatal)
{
	...
	case DDERR_PALETTEBUSY:                  bFatal = false; return "DDERR_PALETTEBUSY";
	case DDERR_COLORKEYNOTSET:               return "DDERR_COLORKEYNOTSET";
	case DDERR_SURFACEALREADYATTACHED:       return "DDERR_SURFACEALREADYATTACHED";
	case DDERR_SURFACEALREADYDEPENDENT:      return "DDERR_SURFACEALREADYDEPENDENT";
	case DDERR_SURFACEBUSY:                  bFatal = false; return "DDERR_SURFACEBUSY";
	case DDERR_CANTLOCKSURFACE:              bFatal = false; return "DDERR_CANTLOCKSURFACE";
	case DDERR_SURFACEISOBSCURED:            return "DDERR_SURFACEISOBSCURED";
	case DDERR_SURFACELOST:                  bFatal = false; return "DDERR_SURFACELOST";
	...
	case DDERR_NOTLOCKED:                    bFatal = false; return "DDERR_NOTLOCKED";
	case DDERR_CANTCREATEDC:                 return "DDERR_CANTCREATEDC";
	case DDERR_NODC:                         return "DDERR_NODC";
	case DDERR_WRONGMODE:                    bFatal = false; return "DDERR_WRONGMODE";
...
bool DDFailedCheck(HRESULT hr, char *szMessage, char * cpErrorBuf)
{
	...
	if (FAILED(hr))
	{
		sprintf( cpErrorBuf, "%s (%s)\n\0", szMessage, DDErrorString(hr, bFatal) );
		OutputDebugString( cpErrorBuf );
		return bFatal;
	}
	return false;
}

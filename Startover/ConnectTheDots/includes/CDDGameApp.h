...
public:
	...
	bool                setDisplaySettings ( bool windowed = false, int bitsPerPixel = BPP, int windowWidth = WINDOW_WIDTH, 
									         int windowHeight = WINDOW_HEIGHT, int backBufferHeight = WINDOW_HEIGHT, 
											 int backBufferWidth = WINDOW_WIDTH, RECT windowRect = RECT(), 
											 SCCOLOR  transparentColor = SCCOLOR(255,0,255) );

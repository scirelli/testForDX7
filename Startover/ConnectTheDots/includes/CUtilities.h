...
public:
	...
	//-----------------------------------------------------------------------------
	static inline int DrawStringGDI( LPDIRECTDRAWSURFACE7 lpddsSurface, int x, int y, const char *string, SCCOLOR c = SCCOLOR(255,255,255) )
	{
		HDC hDC;
		HRESULT ddReturnVal = 0;
	...
	// Desc: Draws a string to a surface using GDI
	//-----------------------------------------------------------------------------
	static inline int DrawLineGDI( LPDIRECTDRAWSURFACE7 lpddsSurface, int x, int y, int x2, int y2, SCCOLOR col)
	{
		HDC hDC;
		HRESULT ddReturnVal = 0;
		static char cpErrorBuf[100];
		...
		HPEN pen = CreatePen(PS_SOLID, 0, RGB(col.r,col.g,col.b)), temppen;

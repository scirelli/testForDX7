...
public:
	...
	void setWndRect            ( RECT wndRect )                         { m_wndRect = wndRect; }
	...
	//Color Methods
	inline unsigned int CreateRGB( int r, int g, int b, int a = 0 )
	{
	...
	//-----------------------------------------------------------------------------
	static inline bool CUtilities::DrawPixel(DDSURFACEDESC2 ddsd, int x, int y, SCCOLOR col)
	{
	...
	// Desc: draws a 16bit pixel to a surface
	//-----------------------------------------------------------------------------
	static inline bool CUtilities::DrawPixel(DDSURFACEDESC2 ddsd, int x, int y, int r, int g, int b)
	{
		unsigned short *video_buffer= (unsigned short*)ddsd.lpSurface;
	...
	// Desc: draws a 16bit pixel to a surface
	//-----------------------------------------------------------------------------
	static inline bool CUtilities::DrawPixel(USHORT *video_buffer, int lPitch, int x, int y, int r, int g, int b)
	{
	...
	// Desc: draws a 32bit pixel to a surface
	//-----------------------------------------------------------------------------
	static inline bool CUtilities::DrawPixel32(DDSURFACEDESC2 ddsd, int x, int y, int r, int g, int b)
	{
		DWORD *video_buffer= (DWORD*)ddsd.lpSurface;
	...
	// Desc: draws a 32bit pixel to a surface
	//-----------------------------------------------------------------------------
	static inline bool CUtilities::DrawPixel32(DWORD *video_buffer, int lPitch, int x, int y, int r, int g, int b)
	{	
	...
	//-----------------------------------------------------------------------------
	static inline bool CUtilities::DrawParticle(DDSURFACEDESC2 ddsd, PARTICLE *particle, int nCurrentMaxParticles)
	{
		int i=0;
	...
	// Desc: draws an array of particles
	//-----------------------------------------------------------------------------
	static inline bool CUtilities::DrawParticle32(DDSURFACEDESC2 ddsd, PARTICLE *particle, int nCurrentMaxParticles)
	{
		DWORD *video_buffer= (DWORD*)ddsd.lpSurface;
	...
	//-----------------------------------------------------------------------------
	static inline int CUtilities::DrawStringGDI( LPDIRECTDRAWSURFACE7 lpddsSurface, int x, int y, const char *string )
	{
		HDC hDC;
		HRESULT ddReturnVal = 0;
	...
	//-----------------------------------------------------------------------------
	static inline int CUtilities::ClrS( LPDIRECTDRAWSURFACE7 lpddsSurface, RECT *destinationRec, int r, int g, int b )
	{
		HRESULT ddReturnVal = 0;
		static char cpErrorBuf[100];
	...
	//-----------------------------------------------------------------------------
	static inline int CUtilities::ClrS(LPDIRECTDRAWSURFACE7 lpddsSurface, RECT *destinationRec)
	{
		HRESULT ddReturnVal = 0;
		static char cpErrorBuf[100];
		static DDBLTFX ddbltfx;
	...
	//-----------------------------------------------------------------------------
	static inline int CUtilities::DrawFillRect(LPDIRECTDRAWSURFACE7 lpddsSurface, int x, int y, int x2, int y2, int r, int g, int b)
	{
	...
	// Desc: blts a rect to a surface
	//-----------------------------------------------------------------------------
	static inline int CUtilities::DrawFillRect(LPDIRECTDRAWSURFACE7 lpddsSurface, RECT destinationRect, SCCOLOR col)
	{
		HRESULT ddReturnVal = 0;
		static char cpErrorBuf[100];
		static DDBLTFX ddbltfx;
	...
	//-----------------------------------------------------------------------------
	static inline int CUtilities::DrawLine(DDSURFACEDESC2 ddsd, int xo, int yo, int x1,int y1, SCCOLOR col)
	{

...
CDDGameApp::CDDGameApp()
{
	...
	for( int i=0; i<256; i++ ) m_nKeyStatus[i] = false;
...
bool CDDGameApp::BuildSprites()
{
	...
	m_nppAnimationList[1] = new int[2]; m_nppAnimationList[1][0] = 1; m_nppAnimationList[1][1] = 9;
	m_nppAnimationList[2] = new int[2]; m_nppAnimationList[2][0] = 2; m_nppAnimationList[2][1] = 10;
	m_nppAnimationList[3] = new int[2]; m_nppAnimationList[3][0] = 3; m_nppAnimationList[3][1] = 11;
	m_nppAnimationList[4] = new int[2]; m_nppAnimationList[4][0] = 4; m_nppAnimationList[4][1] = 12;
	m_nppAnimationList[5] = new int[2]; m_nppAnimationList[5][0] = 5; m_nppAnimationList[5][1] = 13;
	m_nppAnimationList[6] = new int[2]; m_nppAnimationList[6][0] = 6; m_nppAnimationList[6][1] = 14;
	m_nppAnimationList[7] = new int[2]; m_nppAnimationList[7][0] = 7; m_nppAnimationList[7][1] = 15;
	m_nppAnimationList[8] = new int[2]; m_nppAnimationList[8][0] = 16; m_nppAnimationList[8][1] = 24;
	m_nppAnimationList[9] = new int[2]; m_nppAnimationList[9][0] = 17; m_nppAnimationList[9][1] = 25;
	m_nppAnimationList[10] = new int[2]; m_nppAnimationList[10][0] = 18; m_nppAnimationList[10][1] = 26;
	m_nppAnimationList[11] = new int[2]; m_nppAnimationList[11][0] = 19; m_nppAnimationList[11][1] = 27;
	m_nppAnimationList[12] = new int[2]; m_nppAnimationList[12][0] = 20; m_nppAnimationList[12][1] = 28;
	m_nppAnimationList[13] = new int[2]; m_nppAnimationList[13][0] = 21; m_nppAnimationList[13][1] = 29;
	m_nppAnimationList[14] = new int[2]; m_nppAnimationList[14][0] = 22; m_nppAnimationList[14][1] = 30;
	m_nppAnimationList[15] = new int[2]; m_nppAnimationList[15][0] = 23; m_nppAnimationList[15][1] = 31;
	m_nppAnimationList[16] = new int[2]; m_nppAnimationList[16][0] = 0; m_nppAnimationList[16][1] = 0;

	m_pSprites[0].InitSprite(24,24,32,8,4,130);

	m_pSprites[0].SetAnimations(m_nppAnimationList[0],2,SPRITE_ANIM_CONT);  m_pSprites[0].SetAnimations(m_nppAnimationList[1],2,SPRITE_ANIM_CONT);  
	m_pSprites[0].SetAnimations(m_nppAnimationList[2],2,SPRITE_ANIM_CONT);  m_pSprites[0].SetAnimations(m_nppAnimationList[3],2,SPRITE_ANIM_CONT);  
	m_pSprites[0].SetAnimations(m_nppAnimationList[4],2,SPRITE_ANIM_CONT);  m_pSprites[0].SetAnimations(m_nppAnimationList[5],2,SPRITE_ANIM_CONT);  
	m_pSprites[0].SetAnimations(m_nppAnimationList[6],2,SPRITE_ANIM_CONT);  m_pSprites[0].SetAnimations(m_nppAnimationList[7],2,SPRITE_ANIM_CONT);  
	m_pSprites[0].SetAnimations(m_nppAnimationList[8],2,SPRITE_ANIM_CONT);  m_pSprites[0].SetAnimations(m_nppAnimationList[9],2,SPRITE_ANIM_CONT); 
	m_pSprites[0].SetAnimations(m_nppAnimationList[10],2,SPRITE_ANIM_CONT); m_pSprites[0].SetAnimations(m_nppAnimationList[11],2,SPRITE_ANIM_CONT);
	m_pSprites[0].SetAnimations(m_nppAnimationList[12],2,SPRITE_ANIM_CONT); m_pSprites[0].SetAnimations(m_nppAnimationList[13],2,SPRITE_ANIM_CONT); 
	m_pSprites[0].SetAnimations(m_nppAnimationList[14],2,SPRITE_ANIM_CONT); m_pSprites[0].SetAnimations(m_nppAnimationList[15],2,SPRITE_ANIM_CONT); 
	m_pSprites[0].SetAnimations(m_nppAnimationList[16],1,SPRITE_ANIM_ONCE);
	
	m_pSprites[0].SetCurrentAnim(0);
	m_pSprites[0].LoadSpriteImage24("./bitmaps\\Blaze16b.bmp");
	m_pSprites[0].SetState(SPRITE_STATE_ALIVE);
	m_pSprites[0].SetXPos((m_wndRect.right/2)-20);
	m_pSprites[0].SetYPos((m_wndRect.bottom/2)-30);
	m_pSprites[0].physProp.fMass = Ton_Kg(2.f); //kg
	m_pSprites[0].physProp.fCenterofMassX = ( m_pSprites[0].GetXPos()+(((float)m_pSprites[0].GetWidth())*0.5f) );
	m_pSprites[0].physProp.fCenterofMassY = ( m_pSprites[0].GetYPos()+(((float)m_pSprites[0].GetHeight())*0.5f) );
	m_pSprites[0].physProp.fMomentofIneriaZ = (1.f/24.f)*m_pSprites[0].physProp.fMass*( (m_pSprites[0].GetWidth()*m_pSprites[0].GetWidth()) + (m_pSprites[0].GetHeight()*m_pSprites[0].GetHeight()) );
	m_pSprites[0].physProp.angle = 90;
	return true;
}

...
void MoveShip()
{
	...
	{//accelerating
		Sprites[0].physProp.VelVector.x += ((fFrameTime*1000)*(THRUST*cos(Deg_Rad(Sprites[0].physProp.angle))))/Sprites[0].physProp.fMass;
		Sprites[0].physProp.VelVector.y += ((fFrameTime*1000)*(THRUST*sin(Deg_Rad(Sprites[0].physProp.angle))))/Sprites[0].physProp.fMass;
		if(Sprites[0].physProp.VelVector.x > 10)
			Sprites[0].physProp.VelVector.x = 10;
		if(Sprites[0].physProp.VelVector.x < -10)
			Sprites[0].physProp.VelVector.x = -10;
		if(Sprites[0].physProp.VelVector.y > 10)
			Sprites[0].physProp.VelVector.y = 10;
		if(Sprites[0].physProp.VelVector.y < -10)
			Sprites[0].physProp.VelVector.y = -10;

...
HWND SetupWindow(WNDCLASS *winclass, HINSTANCE hInstance)
{
	...
	if (!(hWnd = CreateWindow(WINDOW_CLASS_NAME, // class
							  cpWindowName,	 // title
							  WS_OVERLAPPEDWINDOW | WS_VISIBLE,  //WS_POPUP | WS_VISIBLE, WS_OVERLAPPEDWINDOW,WS_OVERLAPPED
						 	  0,0,	   // x,y
							  WINDOW_WIDTH,  // width
							  ...
							  NULL,	   // handle to menu
							  hInstance,// instance
							  NULL)))	// creation parms where you can pass in whatever u like
	{
...
{// this function is where i do all the initialization 
 // for the game
	...
	*/
	...
	lpddsSecondary = CreateSurface(SECONDARY_SURF_WIDTH, SECONDARY_SURF_HEIGHT, col);
